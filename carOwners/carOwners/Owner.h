...
class Owner
{
	private:
		...
		/**********може ли да си създавам обекта Car само в cpp файла и как да използвам 
				   конструктора на Car със зададени параметри???????********************/
	...
	private:
		...
		//Delete
		void delete_RegNum_From_List(const int number);
